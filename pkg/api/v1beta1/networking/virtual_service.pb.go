...
// 	protoc        v3.19.4
// source: networking/v1beta1/traffic_router.proto

// $schema: istio.networking.v1beta1.VirtualServiceSpec
...
// services.
//
// A `VirtualServiceSpec` defines a set of traffic routing rules to apply when a host is
...
//
// <!-- crd generation tags
// +cue-gen:VirtualServiceSpec:groupName:traffic.opensergo.io
// +cue-gen:VirtualServiceSpec:version:v1beta1
// +cue-gen:VirtualServiceSpec:annotations:helm.sh/resource-policy=keep
// +cue-gen:VirtualServiceSpec:labels:app=istio-pilot,chart=istio,heritage=Tiller,release=istio
// +cue-gen:VirtualServiceSpec:subresource:status
// +cue-gen:VirtualServiceSpec:scope:Namespaced
// +cue-gen:VirtualServiceSpec:resource:categories=istio-io,networking-istio-io,shortNames=vs
// +cue-gen:VirtualServiceSpec:printerColumn:name=Gateways,type=string,JSONPath=.spec.gateways,description="The names of gateways and sidecars
// that should apply these routes"
// +cue-gen:VirtualServiceSpec:printerColumn:name=Hosts,type=string,JSONPath=.spec.hosts,description="The destination hosts to which traffic is being sent"
// +cue-gen:VirtualServiceSpec:printerColumn:name=Age,type=date,JSONPath=.metadata.creationTimestamp,description="CreationTimestamp is a timestamp
// representing the server time when this object was created. It is not guaranteed to be set in happens-before order across separate operations.
// Clients may not set this value. It is represented in RFC3339 form and is in UTC.
// Populated by the system. Read-only. Null for lists. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata"
// +cue-gen:VirtualServiceSpec:preserveUnknownFields:false
// -->
//
...
// +istio.io/sync-from:networking/v1alpha3/traffic_router.proto
// -->
type VirtualServiceSpec struct {
	...
	//
	// A single VirtualServiceSpec can be used to describe all the traffic
	...
	// can be defined using more than one VirtualServiceSpec, with certain
	...
	//
	// *Note*: It must be empty for a delegate VirtualServiceSpec.
	...
	// namespace qualifier is the same as specifying the VirtualServiceSpec's
	// namespace. A single VirtualServiceSpec is used for sidecars inside the mesh as
...
func (x *VirtualServiceSpec) GetHosts() []string {
	if x != nil {
		return x.Hosts
	}
	return nil
...
func (x *VirtualServiceSpec) GetGateways() []string {
	if x != nil {
		return x.Gateways
	}
	return nil
...
func (x *VirtualServiceSpec) GetHttp() []*HTTPRoute {
	if x != nil {
		return x.Http
	}
	return nil
...
func (x *VirtualServiceSpec) GetTls() []*TLSRoute {
	if x != nil {
		return x.Tls
	}
	return nil
...
func (x *VirtualServiceSpec) GetTcp() []*TCPRoute {
	if x != nil {
		return x.Tcp
	}
	return nil
...
func (x *VirtualServiceSpec) GetExportTo() []string {
	if x != nil {
		return x.ExportTo
	}
	return nil
...
// {{</tabset>}}
//
// The following VirtualServiceSpec sets a timeout of 5s for all calls to
...
// gRPC traffic. See VirtualServiceSpec for usage examples.
type HTTPRoute struct {
	...
	// Delegate is used to specify the particular VirtualServiceSpec which
	// can be used to define delegate HTTPRoute.
	//
	// It can be set only when `Route` and `Redirect` are empty, and the route
	// rules of the delegate VirtualServiceSpec will be merged with that in the
	// current one.
	//
	// **NOTE**:
	//
...
// Describes the delegate VirtualServiceSpec.
// The following routing rules forward the traffic to `/productpage` by a delegate VirtualServiceSpec named `productpage`,
// forward the traffic to `/reviews` by a delegate VirtualServiceSpec named `reviews`.
//
// ```yaml
// apiVersion: networking.istio.io/v1alpha3
// kind: VirtualServiceSpec
...
type Delegate struct {
	...
	// Name specifies the name of the delegate VirtualServiceSpec.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Namespace specifies the namespace where the delegate VirtualServiceSpec resides.
...
// The following VirtualServiceSpec adds a `test` header with the value `true`
...
// **Note:** No regex string match can be set when delegate VirtualServiceSpec is specified.
type HTTPMatchRequest struct {
	...
	// with the given labels. If the VirtualServiceSpec has a list of gateways specified
	...
	// in the top-level `gateways` field of the VirtualServiceSpec (if any) are overridden. The gateway
	...
	// If the VirtualServiceSpec has a list of gateways specified in the top-level `gateways` field,
...
type L4MatchAttributes struct {
	...
	// workloads with the given labels. If the VirtualServiceSpec has a list of
...
// Fault specification is part of a VirtualServiceSpec rule. Faults include
...
var file_networking_v1beta1_virtual_service_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa1, 0x02,
	...
	0x73, 0x22, 0x78, 0x0a, 0x10, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4c, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61,
	...
	0x01, 0x28, 0x05, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xe9, 0x02, 0x0a, 0x11,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x12, 0x62, 0x0a, 0x0d, 0x73,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xfd, 0x02, 0x0a, 0x12, 0x54, 0x4c, 0x53, 0x4d,
	...
	0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x63, 0x0a, 0x0d, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3e, 0x2e, 0x69,
	0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e,
	...
	0x5f, 0x73, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x22, 0xce, 0x02, 0x0a, 0x0c, 0x48, 0x54, 0x54, 0x50,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x5f,
	0x0a, 0x0b, 0x64, 0x65, 0x72, 0x69, 0x76, 0x65, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x3c, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6e, 0x65, 0x74, 0x77,
	0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x48,
	...
	0x65, 0x63, 0x74, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x69, 0x0a, 0x12, 0x48, 0x54, 0x54, 0x50,
	...
	0xe0, 0x41, 0x02, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x36, 0x0a, 0x04, 0x62,
	...
	0x65, 0x6e, 0x74, 0x22, 0x32, 0x0a, 0x0c, 0x50, 0x6f, 0x72, 0x74, 0x53, 0x65, 0x6c, 0x65, 0x63,
	0x74, 0x6f, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x4a, 0x04, 0x08, 0x02, 0x10,
	0x03, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x1f, 0x0a, 0x07, 0x50, 0x65, 0x72, 0x63, 0x65,
	0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x01, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x21, 0x5a, 0x1f, 0x69, 0x73, 0x74, 0x69,
...
var file_networking_v1beta1_virtual_service_proto_depIdxs = []int32{
	3,  // 0: istio.networking.v1beta1.VirtualServiceSpec.http:type_name -> istio.networking.v1beta1.HTTPRoute
	6,  // 1: istio.networking.v1beta1.VirtualServiceSpec.tls:type_name -> istio.networking.v1beta1.TLSRoute
	7,  // 2: istio.networking.v1beta1.VirtualServiceSpec.tcp:type_name -> istio.networking.v1beta1.TCPRoute
